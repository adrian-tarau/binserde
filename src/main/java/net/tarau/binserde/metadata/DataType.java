...
public enum DataType {
    ...
    COLLECTION(20, Category.COLLECTION),
    LIST(21, Category.COLLECTION),
    SET(22, Category.COLLECTION),
    SORTED_SET(23, Category.COLLECTION),
    QUEUE(24, Category.COLLECTION),
    DEQUE(25, Category.COLLECTION),
    MAP(26, Category.COLLECTION),
    SORTED_MAP(27, Category.COLLECTION),
