...
import net.tarau.binserde.AbstractSerdeTestCase;
import net.tarau.binserde.deserializer.ReflectionDeserializer;
import net.tarau.binserde.dto.AllSupportedTypes;
import net.tarau.binserde.dto.CollectionTypes;
import net.tarau.binserde.dto.NumberTypes;
import net.tarau.binserde.dto.TimeTypes;
